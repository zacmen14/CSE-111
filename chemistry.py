...
def main():
    ...
    parsed_formula = parse_formula(formula, periodic_table_dict)

    # Call the compute_molar_mass function to compute the
    # molar mass of the molecule from the compound list.
    computed_molar = compute_molar_mass(parsed_formula, periodic_table_dict)
    # Compute the number of moles in the sample.
    number_of_moles = grams/computed_molar
    # Print the molar mass.

    print(round(computed_molar, 5), "grams/mole")
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    #symbol_quantity_list = [SYMBOL_INDEX, QUANTITY_INDEX]
    
    #for symbol_key, periodic_list in periodic_table_dict.items():
        #atomic_mass = periodic_list[ATOMIC_MASS_INDEX]
        #name = periodic_list[NAME_INDEX]
        #symbol = periodic_list[SYMBOL_INDEX]
        #quantity = periodic_list[QUANTITY_INDEX]

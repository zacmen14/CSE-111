...
def main():
    ...
    birth_str = input("Please enter birthdate (YYYY-MM-DD): ")
    pounds = float(input("Please enter Height (in U.S. pounds): "))
    inches = float(input("Please enter Weight (in U.S. inches): "))
